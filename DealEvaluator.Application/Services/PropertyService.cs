...
public class PropertyService : IPropertyService
{
    ...
    /// <summary>
    /// Gets auto-generated rehab line items based on property details (public API endpoint)
    /// </summary>
    public async Task<List<CreateRehabLineItemDto>> GetAutoGeneratedRehabEstimateAsync(int propertyId, string userId)
    {
        ...
        return await GenerateAutoRehabLineItemDtosAsync(property, userId);
    }
}